...
public class AppointmentRequestController {
    ...
    public List<AppointmentRequest> getRequestsByDoctorIdAndStatus(@PathVariable String doctorId,
                                                                    @RequestParam String status) {
        return requestService.getRequestsByDoctorIdAndStatus(doctorId, status);
    }
